  ...
  const emailColumns = useMemo(() => {
    const columns = [
      ...
      },
      {
        ...
        render: (transaction) => {
          return (
            <SourceBadge source={transaction?.source} email_metadata={transaction?.email_metadata} parser_metadata={transaction?.parser_metadata} gmail_msg_id={transaction?.gmail_message_id} />
          );
        },
      },
      {
